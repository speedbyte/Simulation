...
figure(14);
[histData1, x, y, z]=PLOT_3D(files, 14, 5, 4,  [55,67,57,52,40;125,60,60,60,50;125,60,60,60,50;125,70,70,70,60;125,100,100,100,90],...
'Image Size [1=320x240]', 'Block Size [1=65x49]', 'Error[%]')
hold on
figure(15);
surf(x,y,z().*0.8)
hold on
%histData2=PLOT_3D(files, 9, 5, 4,  [1,1,1,1,1],'Image Size [1=320x240]', 'Block Size [1=65x49]', 'Error')
title('BMOF Image Size vs Block Size')
xlabel('Image Size [1=320x240]');
ylabel('Block Size [1=65x49]');
zlabel('Error[%]');
hold off


%[histData2, xd, yd, zd]=PLOT_3D(files, 8, 5, 4,  [1,1,1,1,1],'Image Size [1=320x240]', 'Block Size [1=65x49]', 'Error');
...
xlabel('Image Size [1=320x240]')
ylabel('Error[%]')
title('COOF Image Size Variation')
hold off
...
hold on
figure(2);
histData3=PLOT_3D(files, 10, 5, 4,  [1,1,1,1,1],'Frame Rate [1=10ms]', 'Block Size [1=65x49]', 'Error')
hold on
histData4=PLOT_3D(files, 5, 5, 4,  [1,1,1,1,1],'Frame Rate [1=10ms]', 'Block Size [1=65x49]', 'Error')
...
hold on
figure(3);
histData5=PLOT_3D(files, 10, 5, 4,  [1,1,1,1,1],'Image Size [1=320x240]', 'Frame Rate [1=10ms]', 'Error')
hold on
histData6=PLOT_3D(files, 5, 5, 4,  [1,1,1,1,1],'Image Size [1=320x240]', 'Frame Rate [1=65x49]', 'Error')

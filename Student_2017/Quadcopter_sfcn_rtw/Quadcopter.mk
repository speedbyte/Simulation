...
MODEL              = Quadcopter
MODULES            = Quadcopter_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = Quadcopter.mk
MATLAB_ROOT        = Y:\Matlab\R2014b
ALT_MATLAB_ROOT    = Y:\Matlab\R2014b
MATLAB_BIN         = Y:\Matlab\R2014b\bin
ALT_MATLAB_BIN     = Y:\Matlab\R2014b\bin
MASTER_ANCHOR_DIR  = 
START_DIR          = Z:\Matlab\Project_sem2\Student_2017_Final\Path_Model
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=Quadcopterlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f "C:\Users\magogs00\AppData\Roaming\MathWorks\MATLAB\R2014b\mex_C_win64.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 10.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Quadcopter_sfcn_rtw

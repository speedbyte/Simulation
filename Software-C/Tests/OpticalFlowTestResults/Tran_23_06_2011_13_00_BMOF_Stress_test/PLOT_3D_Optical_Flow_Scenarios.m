...
hold on
figure(2);
histData3=PLOT_3D(files, 10, 5, 2, [1,1,1,1,1],'Frame Rate [1=10ms]', 'Block Size [1=65x49]', 'Error')
hold on
...
hold on
figure(3);
histData5=PLOT_3D(files, 10, 5, 2, [1,1,1,1,1],'Image Size [1=320x240]', 'Frame Rate [1=10ms]', 'Error')
hold on

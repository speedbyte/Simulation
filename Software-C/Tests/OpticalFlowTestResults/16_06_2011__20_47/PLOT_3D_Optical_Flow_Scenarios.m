...
% % hold on
% % figure(14);
% % histData1=PLOT_3D(files, 10, 5, 2, [1,1,1,1,1],'Image Size [1=320x240]', 'Block Size [1=65x49]', 'Error')
% % hold on
% % histData2=PLOT_3D(files, 5, 5, 2, [1,1,1,1,1],'Image Size [1=320x240]', 'Block Size [1=65x49]', 'Error')
...
% hold on
% figure(2);
% histData3=PLOT_3D(files, 10, 5, 2, [0.8, 1.29, 1.7, 2.9, 6.2;0.8, 1.29, 1.7, 2.9, 6.2;0.8, 1.29, 1.7, 2.9, 6.2;0.8, 1.29, 1.7, 2.9, 6.2;...
%     0.8, 1.29, 1.7, 2.9, 6.2],'Frame Rate [1=10ms]', 'Block Size [1=65x49]', 'Error')
% hold on
% histData4=PLOT_3D(files, 5, 5, 2, [3*0.69, 3*1.39, 3*2.2, 3*3.3, 3*6.92;...
%                                    3*0.69, 3*1.39, 3*2.2, 3*3.3, 3*6.92;...
%                                    3*0.69, 3*1.39, 3*2.2, 3*3.3, 3*6.92;...
%                                    3*0.69, 3*1.39, 3*2.2, 3*3.3, 3*6.92;...
%                                    3*0.69, 3*1.39, 3*2.2, 3*3.3, 3*6.92].*gain,'Frame Rate [1=10ms]', 'Block Size [1=65x49]', 'Error')
% title('BMOF vs. COOF Frame Rate vs Block Size')
% hold off
% 
% hold on
% figure(15);
% histData3=PLOT_3D(files, 10, 5, 2, [0.3, 0.3, 0.3, 0.3, 0.3;...
%                                     0.3, 0.3, 0.3, 0.3, 0.3;...
%                                     0.3, 0.3, 0.3, 0.3, 0.3;...
%                                     0.3, 0.3, 0.3, 0.3, 0.3;...
%                                      0.3, 0.3, 0.3, 0.3, 0.3;...
%     ],'Frame Rate [1=10ms]', 'Block Size [1=65x49]', 'Error')
% hold on
...
gain=[1.2 1.2 1.2 1.2 1.2]
hold on
figure(3);
[histData5, x, y, z]=PLOT_3D(files, 10, 5, 2, [[0.8, 1.29, 1.7, 2.9, 6.2].*gain;...
                                               [0.8, 1.29, 1.7, 2.9, 6.2].*gain;...
                                               [0.8, 1.29, 1.7, 2.9, 6.2].*gain;...
                                               [0.8, 1.29, 1.7, 2.9, 6.2].*gain;...
                                               [0.8, 1.29, 1.7, 2.9, 6.2].*gain],'Image Size [1=320x240]', 'Frame Rate [1=10ms]', 'Error')
hold on
histData6=PLOT_3D(files, 5, 5, 2, [[2.1,4,6.25,10.52,22.47];[2.1,4,6.25,10.52,22.47]...
    ;[2.1,4,6.25,10.52,22.47];[2.1,4,6.25,10.52,22.47];[2.1,4,6.25,10.52,22.47]],'Image Size [1=320x240]', 'Frame Rate [1=65x49]', 'Error')

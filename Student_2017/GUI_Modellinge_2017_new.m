function varargout = GUI_Modellinge_2017_new(varargin)
%GUI_MODELLINGE_2017_NEW MATLAB code file for GUI_Modellinge_2017_new.fig
%      GUI_MODELLINGE_2017_NEW, by itself, creates a new GUI_MODELLINGE_2017_NEW or raises the existing
%      singleton*.
%
%      H = GUI_MODELLINGE_2017_NEW returns the handle to a new GUI_MODELLINGE_2017_NEW or the handle to
%      the existing singleton*.
%
%      GUI_MODELLINGE_2017_NEW('Property','Value',...) creates a new GUI_MODELLINGE_2017_NEW using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to GUI_Modellinge_2017_new_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      GUI_MODELLINGE_2017_NEW('CALLBACK') and GUI_MODELLINGE_2017_NEW('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GUI_MODELLINGE_2017_NEW.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help GUI_Modellinge_2017_new

% Last Modified by GUIDE v2.5 28-Mar-2017 17:53:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_Modellinge_2017_new_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Modellinge_2017_new_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_Modellinge_2017_new is made visible.
function GUI_Modellinge_2017_new_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for GUI_Modellinge_2017_new
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_Modellinge_2017_new wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_Modellinge_2017_new_OutputFcn(hObject, eventdata, handles)
...
% --- Executes on button press in si_button.
function si_button_Callback(hObject, eventdata, handles)
% hObject    handle to si_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of si_button


% --- Executes on button press in eng_button.
function eng_button_Callback(hObject, eventdata, handles)
% hObject    handle to eng_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of eng_button
...
function unitPanel_SelectionChangedFcn(hObject, eventdata, handles)

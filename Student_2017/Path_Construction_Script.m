...
%clear path
%% This demonstration script generates a much more Circle path.
% Note that it takes a long time to run and each step is five seconds
% Circle Plot
X = [0, 1, 0.866, 0.707, 0.5, 0, -0.5, -0.707, -0.866, -1, -0.866, -0.707, -0.5, 0, 0.5, 0.707, 0.866, 1, 0, 0];% meters 20 pts
X = X*0.1; 
Y = [0, 0, 0.5, 0.707, 0.866, 1, 0.866, 0.707, 0.5, 0, -0.5, -0.707, -0.866, -1, -0.866, -0.707, -0.5, 0, 0, 0];
Y = Y*0.1;
Z = [3];

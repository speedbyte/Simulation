...
xlabel('Time [s]');
ylabel('x-velocity [m/s]');
title('Variation BS;IS=65x49;UND=Segmented Amorphous;FR=80 FPS;ALGO=BMOF');
hold off
...
xlabel('Time [s]');
ylabel('x-velocity [m/s]');
title('Variation IS;BS=320x240;UND=Segmented Amorphous;FR=80 FPS;ALGO=BMOF');
hold off
...
pl2=PLOT_FILES(files(1,:),2, 1)
set(pl2,'Color','k')
PLOT_FILES(files,5, [20,20,20,20,20])
legend(['Stimuli    ';
        'IS=320x240 ';
        'IS=640x480 ';
        'IS=768x576 ';
...
xlabel('Time [s]');
ylabel('x-velocity [m/s]');
title('Variation IS;UND=Segmented Amorphous;FR=80 FPS;ALGO=COOF');
hold off

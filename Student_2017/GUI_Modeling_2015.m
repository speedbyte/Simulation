...
%  get(hObject,'String') returns contents of massTotal_edit as text
...
%  get(hObject,'String') returns contents of ct_edit as text
...
% get(hObject,'String') returns contents of cq_edit as text
...
% get(hObject,'String') returns contents of motor_m_edit as text
...
%  get(hObject,'String') returns contents of motor_dm_edit as text
...
% get(hObject,'String') returns contents of motor_r_edit as text
...
%  get(hObject,'String') returns contents of ESC_m_edit as text
...
%  get(hObject,'String') returns contents of ESC_a_edit as text

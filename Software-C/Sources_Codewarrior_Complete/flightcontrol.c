...
{
   // P-Values:
   /*static float rpsi_rpsi = 7.273;
   static float rpsi_theta = -0.321;
   static float rpsi_phi = -0.003;
   
   static float theta_rpsi = 0;
   static float theta_theta = 79.358;
   static float theta_phi = 0;
   
   static float phi_rpsi = -0.572;
   static float phi_theta = 0.025;
   static float phi_phi = 65.05;
   
   static float rpsi_Rrpsi = 7.273;
   static float rpsi_Rtheta = 0;
   static float rpsi_Rphi = -0.572;
   static float rpsi_Rrphi = -0.072;
   static float rpsi_Rrtheta = 0.037;

   static float theta_Rrpsi = 0.758;
   static float theta_Rtheta = 79.358;
   static float theta_Rphi = 0.025;
   static float theta_Rrphi = 0.003;
   static float theta_Rrtheta = 20.279;
   
   static float phi_Rrpsi = -0.003;
   static float phi_Rtheta = 0;
   static float phi_Rphi = 65.05;
   static float phi_Rrphi = 15.798;

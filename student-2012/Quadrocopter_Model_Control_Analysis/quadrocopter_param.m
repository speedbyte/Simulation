...
% Battery pack + landing skids
bat.I_x = 1/12*bat.m*(bat.h^2+bat.l^2)+bat.m*bat.d(3)^2;    % in Nms^2
...
% Dimensions for pos-vel-acc vector
pos_vel_acc_dim=22;

%Parameters for PID Controlers
%Body Control
bodyCtrl_phiCtrl_KP = 133.0779;
bodyCtrl_phiCtrl_KI = 0.6630;
bodyCtrl_phiCtrl_KD = 0.1321;

bodyCtrl_thetaCtrl_KP =  137.4441;
bodyCtrl_thetaCtrl_KI =  1.1171;
bodyCtrl_thetaCtrl_KD =  0.8394;

bodyCtrl_rpsiCtrl_KP = 60.6000;
bodyCtrl_rpsiCtrl_KI =  0.1270;
bodyCtrl_rpsiCtrl_KD = 0.9134;

bodyCtrl_rphiCtrl_KP = 61.1734;
bodyCtrl_rphiCtrl_KI = 0.5156;
bodyCtrl_rphiCtrl_KD = 0.9225;

bodyCtrl_rthetaCtrl_KP =  1013;
bodyCtrl_rthetaCtrl_KI =  2.2836;
bodyCtrl_rthetaCtrl_KD =  0.9332;

positionCtrl_rpsiCtrl_KP = 10;  
positionCtrl_rpsiCtrl_KI = 0.5;
positionCtrl_rpsiCtrl_KD = 0;

positionCtrl_rthetaCtrl_KP = 10;
positionCtrl_rthetaCtrl_KI = 0.5;
positionCtrl_rthetaCtrl_KD = 0;

positionCtrl_rphiCtrl_KP = 10;  
positionCtrl_rphiCtrl_KI = 0.5;
positionCtrl_rphiCtrl_KD = 0;
